  ...
  return (
    ...
    <div className="bg-white w-2/3 rounded-xl shadow-md p-6 text-center border border-pink-100">
      ...
      <button
        ...
        className="bg-gradient-to-r from-pink-600 to-pink-700 text-white font-medium py-2 px-4
         rounded-lg hover:from-pink-700 hover:to-pink-800 transition-all duration-300"
      >
        Browse Products
      </button>
    </div>
