      ...
      {[
        ...
        >
          ...
          <div className="p-6">
            ...
            <button className="w-full py-3 bg-yellow-500 hover:bg-yellow-400 text-black font-medium rounded-lg transition-colors duration-300 flex items-center justify-center"   onClick={() => navigate('/products')}>
              <span>Discover</span>
